...
pyh.Waveform(saveLevel=1); DPT.objects.processDirs(dirs=None, objtype=pyh.VMPlaceCell, saveLevel=1); \
DPT.objects.processDirs(dirs=None, objtype=pyh.VMPlaceCell, GridSteps=5, saveLevel=1); \
